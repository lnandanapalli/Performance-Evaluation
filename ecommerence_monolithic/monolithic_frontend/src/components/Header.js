...
export const Header = () => {
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <Link to="/login" className="btn-lg nav-link text-white">
                            <i class="fas fa-user">{profile.email}</i>
                            <span className="ml-1" onClick={() => window.location.reload(true)} >&nbsp; &nbsp; Logout</span>
                        </Link>
                    </li>
            </ul>
            );
   ...
   return ( <nav class="navbar navbar-expand-sm navbar-light border-bottom" style={{ backgroundColor: '#61AB4F'}}>
            <div class="container-fluid">
                <a href="#"><Link class="navbar-brand text-white" to="/">CloudEval Shopping</Link></a>
